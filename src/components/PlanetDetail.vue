  ...
  <div class="">
    ...
    <div class="flex justify-center">
      <button
        type="button"
        v-on:click="onReturn"
        class="bg-gradient-to-r from-teal-400 bg-blue-500 hover:bg-blue-400 text-white font-medium py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded flex justify-center"
      >
        一覧へ戻る
      </button>
    </div>
